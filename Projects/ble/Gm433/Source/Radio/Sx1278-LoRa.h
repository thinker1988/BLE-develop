...
#define REG_LR_LORADRECVOPTIMIZE_2F					0x2F
#define REG_LR_LORADRECVOPTIMIZE_30					0x30
...
typedef struct sSX1276LR
{
	...
	uint8_t RegTestReserved2B_2E[0x2E - 0x2A];		// 0x2B-0x2E
	uint8_t RegTestReserved2F;						// 0x2F
	uint8_t RegTestReserved30;					// 0x30
	uint8_t RegDetectOptimize;					// 0x31	
	uint8_t RegTestReserved32;					// 0x32	
	uint8_t RegInvertIQ;						// 0x33 
	uint8_t RegTestReserved34_36[0x36 - 0x33];		// 0x34-0x36 
	uint8_t RegDetectionThreshold;				// 0x37
	uint8_t RegTestReserved38_3F[0x3F - 0x37];		// 0x38-0x3F
	// I/O settings				
	...
	// Test
	uint8_t RegTestReserved45_4A[0x4A - 0x44];		// 0x45-0x4A	
	// Additional settings	
	...
	// Test	
	uint8_t RegTestReserved4E_5A[0x5A - 0x4D];		// 0x4E-0x5A	
	// Additional settings
	...
	// Additional settings	
	uint8_t RegTestReserved5E_60[0x60 - 0x5D];		// 0x5E-0x60
	// Additional settings
	...
	// Test
	uint8_t RegTestReserved65_6F[0x6F - 0x64];		// 0x65-0x70
}tSX1276LR;
